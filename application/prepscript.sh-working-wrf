...
sudo yum -y install libaec-devel.x86_64
sudo yum -y install libaec.x86_64 
sudo yum -y libidn-devel.x86_64 libssh2-devel.x86_64
sudo yum -y install centos-release-scl-rh.noarch compat-libstdc++-33.i686 redhat-lsb-core compat-libstdc++-33.x86_64 libmpc-devel.x86_64 libxml2-static.x86_64 gmp-devel.x86_64 mpfr-devel.x86_64
# Install pip
